...
// MaximumLikelihoodMethod.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMaximumLikelihoodMethodApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMaximumLikelihoodMethodApp

CMaximumLikelihoodMethodApp::CMaximumLikelihoodMethodApp()
{
...
// Единственный объект CMaximumLikelihoodMethodApp

CMaximumLikelihoodMethodApp theApp;


// Инициализация CMaximumLikelihoodMethodApp

BOOL CMaximumLikelihoodMethodApp::InitInstance()
{
	...
	CMaximumLikelihoodMethodDlg dlg;
	m_pMainWnd = &dlg;
